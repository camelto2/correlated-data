...
ecps = ['uc','bfd','stu','ccECP.S','ccECP']
styles = {
'uc'        :{'label': 'UC',       'color':'#e41a1c','linestyle':'-'                       },
'bfd'       :{'label': 'BFD',      'color':'#377eb8','linestyle':'--','dashes': (6,3)      }, 
'stu'     :{'label': 'STU',      'color':'#4daf4a','linestyle':'--','dashes': (12,6)     },
'ccECP.S':{'label': 'ccECP.S','color':'#ff7f00','linestyle':'--','dashes': (18,12,3,6)},
'ccECP':{'label': 'ccECP','color':'k','linestyle':'--','dashes': (18,12,3,6)},
}
