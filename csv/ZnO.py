...
#~~~~~~~~~~~~~~input~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
name='ZnO_qz'		# Name of csv file
ri=1.4			# Initial bond length (Angs)
rf=1.9			# Final bond length (Angs)
...
for column in df:
	if column == "r":
		...
		#~~~~~~~~~Plots~~~~~~~~~~~~~~~~~~~
		x=np.linspace(df['r'].loc[0],df['r'].loc[len(df['r'])-1],20)
		
		fig1, ax1 = plt.subplots()
		plt.plot(df['r'], df[column], 'ko')
...
##~~~~~~~~~~~~~Oxides~~~~~~~~~~~~~~~~~~
blatex=blatex[['ae','uc','bfd-bfd','stu-stu','gm99-spectra', 'zn193' ]]
blatex=blatex.rename(index=str, columns={"ae": "AE", "uc": "UC", "bfd-bfd": "BFD", "stu-stu": "STU", "tn17-tn17": "eCEPP"}) #, "g43-lm": "Our ccECP"})


#~~~~~~~~~~~~~~Hydrides~~~~~~~~~~~~~~~~~~~~~~~
#blatex=blatex[['ae','uc','bfd','stu','tn17','g43', 'g73']]
